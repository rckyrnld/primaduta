                    ...
                    <div class="card rounded-0">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <?php
                                if(!empty($this->session->sessperwakilandok)) {
                                    ?>
                                    <div class="alert alert-primary rounded-0" role="alert">
                                        <?php echo $this->session->sessperwakilandok; ?>
                                    </div>
                                    <?php
                                    $this->session->unset_userdata('sessperwakilandok');
                                }
                                ?>
                                <div class="card rounded-0">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <form id="frmdok" name="frmdok" method="post" action="<?php echo base_url('main/updatedokumenperwakilan'); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-9" id="divup">
                                                            ...
                                                            <label class="col-md-9 form-text">Maksimal ukuran file 5 MB</label>
                                                            <?php
                                                            if(!empty($vfile)) {
                                                                ?>
                                                                <label class="col-md-9">File Sebelumnya: <br>
                                                                <span><a href="<?php echo base_url('assets/uploads/perwakilan/'.$vfile); ?>"><?php echo $vnmfile; ?></a></span>
                                                                </label>
                                                                <?php
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group py-2">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <a class="btn btn-warning form-control rounded-0" href="<?php echo base_url('main/dokperwakilan/'.$this->secure->encrypt_url($idprofil)); ?>"><i class="fa-solid fa-rotate"></i> Reset</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                                        ...
                                                        if($n > 0) {
                                                            for ($i = 0; $i < count($d); ++$i) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end">
                                                                        <a href="<?php echo base_url('main/dokperwakilan/'.$this->secure->encrypt_url($d[$i]->idprofil).'/'.$this->secure->encrypt_url($d[$i]->iddokumen)); ?>" class="text-success">Edit</a> |
                                                                ...
                                                                <div class="modal fade rounded-0" tabindex="-1" id="modalhapus<?php echo $i; ?>" role="dialog" aria-labelledby="modallabel" aria-hidden="true">
                                                                    <div class = "modal-dialog">
                                                                      <div class = "modal-content">
                                                                        <form role="form" method="post" action="<?=base_url()?>main/hapusdokperwakilan">
