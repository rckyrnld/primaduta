                ...
                <div class="col-lg-12 mb-2">
                    <div class="card rounded-0">
                        <div class="card-body">
                            ...
                            <div>
                                <p class="py-2" style="font-size: 16px;">PENDAFTARAN PESERTA</p>
                                <div class="row">
                                    <div class="col">
                                        <a href="<?php echo base_url('main/tambahbuyer'); ?>" class="btn btn-success rounded-0">Tambah Peserta</a>
                                    </div>
                                </div>
                                <div class="table-responsive py-3">
                                    <p class="form-text pt-2">Klik link <span class="text-success">Edit</span> untuk input/edit data kontak, nilai impor, kisah keberhasilan dan dokumen pendukung</p>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
                                        ...
                                        <tbody>
                                            ...
                                            if($n > 0) {
                                                for ($i = 0; $i < count($d); ++$i) {
                                                    ...
                                                    <tr>
                                                        <td><?php echo $i+1; ?></td>
                                                        <td><?php echo $d[$i]->nmperusahaan; ?></td>
                                                        <td><?php echo $d[$i]->negara; ?></td>
                                                        <td><?php echo $d[$i]->email; ?></td>
                                                        <td class="text-end">
                                                            <a href="<?php echo base_url('main/editbuyer/'.$this->secure->encrypt_url($d[$i]->idprofil)); ?>" class="text-success">Edit</a> |
                                                    ...
                                                    <div class="modal fade rounded-0" tabindex="-1" id="modalhapus<?php echo $i; ?>" role="dialog" aria-labelledby="modallabel" aria-hidden="true">
                                                        <div class = "modal-dialog">
                                                          <div class = "modal-content">
                                                            <form role="form" method="post" action="<?=base_url()?>main/hapusbuyer">
