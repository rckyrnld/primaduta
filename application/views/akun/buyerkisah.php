                    ...
                    <div class="card rounded-0">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <?php
                                if(!empty($this->session->sessbuyerkisah)) {
                                    ?>
                                    <div class="alert alert-primary rounded-0" role="alert">
                                        <?php echo $this->session->sessbuyerkisah; ?>
                                    </div>
                                    <?php
                                    $this->session->unset_userdata('sessbuyerkisah');
                                }
                                ?>
                                <div class="card rounded-0">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <form id="frmkon" name="frmkon" method="post" action="<?php echo base_url('main/updatekisah'); ?>">
                                                    ...
                                                    <div class="row mb-2">
                                                        <label for="textkisah">Ceritakan kisah keberhasilan impor buyer dalam meningkatkan ekspor</label>
